...
# reshapes the array for better performance (rows, cols)
...
# converts labels into a 2d array
...
def predict_security_issue(code_snippet):
    ...
    #takes the label and converts it to 0 and 1
...
#enter code you'd like to test below 
